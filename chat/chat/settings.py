...
# Add your actual domain or IP address here
ALLOWED_HOSTS = ['localhost', '127.0.0.1']  # Update this for deployment
...
INSTALLED_APPS = [
    ...
    'message',  # Add your custom app here
]
...
STATIC_URL = "static/"
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Set STATIC_ROOT for production
